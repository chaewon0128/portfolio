...
export default function Footer({ onNavigate }: IFooter) {
    ...
    return (
        <footer className='h-[699px] mt-10 relative font-Bebas-neue text-white lg:h-[100px] lg:bg-black lg:flex lg:items-center' id="contact" onMouseEnter={onShowImg} onMouseLeave={onHideImg}>
